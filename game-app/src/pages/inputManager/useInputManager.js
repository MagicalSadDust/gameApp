...
import { getMinimalLetterSet, removeWord, isObjectNotInArray } from 'Model/extensions';

const useInputManager = (level = []) => {
  ...
  }, [selectedPointLetters, levelWords, letters, dispatch]);
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < letters.length; i++) {
      ...
      points.push({ x, y, radius, letter: letters[i] });
